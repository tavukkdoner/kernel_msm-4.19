...
uint sysctl_workingset_protection __read_mostly = 1;
uint sysctl_anon_min_ratio  __read_mostly = CONFIG_ANON_MIN_RATIO;
uint sysctl_clean_low_ratio __read_mostly = CONFIG_CLEAN_LOW_RATIO;
uint sysctl_clean_min_ratio __read_mostly = CONFIG_CLEAN_MIN_RATIO;
